...
import com.example.movie_streaming_service.service_implementation.MovieStreamingServiceImp;
...
public class MovieStreamController {
    ...
    @Autowired
    MovieStreamingServiceImp serviceImp;
    private static final String VIDEO_DIRECTORY = "C:\\Users\\ASCENT\\Documents\\SpringAndSpringboot\\video_tutorial\\";
  @GetMapping("/stream/{videoPath}")
    ...
    public ResponseEntity<InputStreamResource> streamVideo2(@PathVariable Long videoInfoId) throws FileNotFoundException {
      String videoPath = serviceImp.getMoviePath(videoInfoId);
